    ...
    function inserirSaldo() {
        ...
        try {
            axios.put('http://10.0.2.2:8000/usuarios/1', {
                ...
                .then(
                    axios.post('http://10.0.2.2:8000/extrato', {
                        cpf: 1,
                        valor: parseFloat(saldo),
                    }))
                .then(console.log('extrato positivo criado com sucesso'))
                ...
                .then(console.log('usuario teve seu saldo reduzido')).then(
                    axios.put(`http://10.0.2.2:8000/vaquinha/${idVaquinha}`, {
                        ...
                        .then(
                            axios.post('http://10.0.2.2:8000/extrato', {
                            cpf: 1,
                            valor: -parseFloat(valorUsuario),
                          }))
                          .then('extrato negativo criado com sucesso')
                        .then(navigation.goBack())
                );
        }
    }
